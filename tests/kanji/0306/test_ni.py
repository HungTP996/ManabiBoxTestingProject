...
# ===================================================================
# == TEST CLASS: 漢字「二」のテストシナリオ ==
# ===================================================================

class TestGo:
    def test_kanji_jon_drawing_only(self, kanji_go_quiz_page: Page):
        """
        テストシナリオ: 漢字「二」を描画し、各ステップを進める（AI検証をスキップ）。
        """
